...
|---|---|---|
| `courses` | мок-словарь в модуле источника | `101`, `202` |
| `events` | корпоративные мероприятия: `title`, `date`, `location`, `format`, `participants`; мок-словарь в модуле источника | `101`, `202` |
